...
var conn = mongoose.createConnection(
  `mongodb+srv://sammedcjain:${password}@cluster0.gldyajt.mongodb.net/evolvedb`,
...
const evSchema = new mongoose.Schema({
  ...
  main_photo: {
    type: String,
    default:
      "https://www.evarena.org/webp/top-5-affordable-electric-cars-for-uk1fc214004c9481e4c8073e85323bfd4b.webp",
  },
  photo1: {
    type: String,
    default:
